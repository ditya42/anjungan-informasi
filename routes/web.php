...
Route::namespace('Admin')->group(function () {
    ...
    Route::post('/DasarLayanan','DasarLayananController@store')->name('dasarlayanan.store');

    //sepertiny harus berbeda sedikit bagian api hukum urlnya dibandingkan dasar layanan
    Route::get('Dasar/DasarLayanan/apihukum/','DasarLayananController@apihukum')->name('dasarlayanan.apihukum');
    ...
    Route::get('/subpersyaratan/data','SubPersyaratanController@data')->name('subpersyaratan.data');
    Route::get('/subpersyaratan/{id}','SubPersyaratanController@index')->name('subpersyaratan.index');
    Route::get('/tambahsubpersyaratan/{id}','SubPersyaratanController@create')->name('subpersyaratan.create');
    Route::get('/editsubpersyaratan/{id}','SubPersyaratanController@edit')->name('subpersyaratan.edit');
    Route::post('/subpersyaratan','SubPersyaratanController@store')->name('subpersyaratan.store');
    Route::DELETE('/subpersyaratan/{id}','SubPersyaratanController@destroy')->name('subpersyaratan.destroy');
    Route::PUT('/updatesubpersyaratan/{id}','SubPersyaratanController@update')->name('subpersyaratan.update');

    Route::get('/subprosedur/data','SubProsedurController@data')->name('subprosedur.data');
    Route::get('/subprosedur/{id}','SubProsedurController@index')->name('subprosedur.index');
    Route::get('/tambahsubprosedur/{id}','SubProsedurController@create')->name('subprosedur.create');
    Route::get('/editsubprosedur/{id}','SubProsedurController@edit')->name('subprosedur.edit');
    Route::post('/subprosedur','SubProsedurController@store')->name('subprosedur.store');
    Route::DELETE('/subprosedur/{id}','SubProsedurController@destroy')->name('subprosedur.destroy');
    Route::PUT('/updatesubprosedur/{id}','SubProsedurController@update')->name('subprosedur.update');
...
Route::namespace('frontend')->group(function () {
    ...
    Route::get('frontend/layanan/{id}', 'IndexController@layanan')->name('frontend.layanan');
