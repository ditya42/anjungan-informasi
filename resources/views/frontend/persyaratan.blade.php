        ...
        <div class="col-lg-12">
          ...
          <ol type = "1">
              ...
              <li>{{ $syarat->uraian_persyaratan }}</li>
                    <ol type = "a">
                    @foreach ($subpersyaratan as $subs)
                            @if ($subs->persyaratan_id == $syarat->persyaratan_id)

                                    <li>{{ $subs->uraian_subpersyaratan }}</li>
        ...
        <div class="col-lg-12">
          ...
          <ol type = "1">
            ...
            <li>{{ $dur->uraian_prosedur }}</li>
                    <ol type = "a">
                        @foreach ($subprosedur as $subs)
                                @if ($subs->prosedur_id == $dur->prosedur_id)

                                        <li>{{ $subs->uraian_subprosedur }}</li>
