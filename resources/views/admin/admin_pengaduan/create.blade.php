...
@section('title') Tambah Pengaduan @endsection
@section('breadcrumb') Tambah Pengaduan @endsection
@section('content')

<h2>TAMBAHKAN PENGADUAN</h2>
<form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="{{route('AdminPengaduan.store')}}" method="POST">
    @csrf
    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label>Tanggapan BKPP</label>
              <textarea name="tanggapan" id="tanggapan" rows="4" cols="10" class="form-control">
                {{ old('tanggapan') }}
              </textarea>
            </div>
            <div class="invalid-feedback">
