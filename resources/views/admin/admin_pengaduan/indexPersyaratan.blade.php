...
@section('title') Persyaratan Layanan @endsection
@section('breadcrumb') Persyaratan Layanan @endsection
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header">
        ...
        <a href="{{ route('persyaratan.create' , $layanan->layanan_id) }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</a>
