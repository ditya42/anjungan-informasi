...
@section('title') Pengelolaan Aduan Layanan @endsection
@section('breadcrumb') Pengelolaan Aduan Layanan @endsection
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header">
        ...
        <a href="{{ route('aduan.create' , $layanan->layanan_id) }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</a>
        ...
        <div class="table-responsive">
          ...
          <thead>
            <tr>
                ...
                <th><center>Pengelolaan Aduan</center></th>
