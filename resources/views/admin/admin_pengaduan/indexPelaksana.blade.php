...
@section('title') Pelaksana Layanan @endsection
@section('breadcrumb') Pelaksana Layanan @endsection
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header">
        ...
        <a href="{{ route('pelaksana.create' , $layanan->layanan_id) }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</a>
        ...
        <div class="table-responsive">
          ...
          <thead>
            <tr>
                ...
                <th><center>Kompetensi Pelaksana</center></th>
    ...
    $(function() {
      ...
      table = $('#data-tables').DataTable({
        ...
        columns : [
          ...
          { data: 'uraian_kompetensi_pelaksana' },
