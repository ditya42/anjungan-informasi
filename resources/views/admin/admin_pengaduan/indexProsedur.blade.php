...
@section('title') Prosedur Layanan @endsection
@section('breadcrumb') Prosedur Layanan @endsection
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header">
        ...
        <a href="{{ route('prosedur.create' , $layanan->layanan_id) }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</a>
