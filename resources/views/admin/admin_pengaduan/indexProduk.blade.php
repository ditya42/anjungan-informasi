...
@section('title') Produk Layanan @endsection
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header">
        ...
        <a href="{{ route('produk.create' , $layanan->layanan_id) }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Tambah</a>
        ...
        <div class="table-responsive">
          ...
          <thead>
            <tr>
                ...
                <th><center>Produk Layanan</center></th>
