...
@section('breadcrumb') Show @endsection
@section('content')
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input readonly value="{{ $data->jabatan->nama_jabatan }}" type="text" class="form-control {{$errors->first('jabatan') ? "is-invalid": ""}}"  name="jabatan" id="jabatan">
        ...
        <div class="col-md-2">
            <div class="form-group">
              <label>Tanggal</label>
              <input readonly value="{{ $data->created_at }}" type="text" class="form-control {{$errors->first('jabatan') ? "is-invalid": ""}}"  name="tanggal" id="tanggal">
