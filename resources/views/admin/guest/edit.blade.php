...
@section('breadcrumb') Edit @endsection
@section('content')

<h2>EDIT PENGADUAN</h2>
<form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="{{route('pengaduan.update', ['id' => $data->id])}}" method="POST">
    @csrf
  ...
  <div class="box box-default">
    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
              <label>Ganti/Upload Ulang Bukti Laporan(max 25 mb)</label>
